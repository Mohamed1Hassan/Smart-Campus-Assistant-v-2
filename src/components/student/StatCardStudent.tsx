  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between z-10">
        ...
        <div
          className={`p-2.5 sm:p-3.5 rounded-xl ${color} shadow-lg group-hover:scale-110 transition-transform duration-300 ring-4 ring-white/50 dark:ring-gray-800/50 shrink-0`}
        >
