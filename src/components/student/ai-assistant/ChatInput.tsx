  ...
  return (
    <motion.div
      ...
      className={
        chromeless
          ? ""
          : "bg-white dark:bg-cardDark border-t border-gray-200 dark:border-gray-700 p-4"
      }
    >
