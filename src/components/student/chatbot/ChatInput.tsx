...
export default function ChatInput({
  ...
  const { isListening, startListening, stopListening } = useVoiceRecognition((text) => {
    setMessage(text);
  });
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="relative">
        <div
          className={`relative flex items-end gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl border transition-all duration-200 ${
        ...
        >
          ...
          <motion.button
            ...
            className={`p-2 transition-colors duration-200 ${
              isListening ? "text-blue-500 animate-pulse" : "text-gray-400 dark:text-gray-500 hover:text-blue-500"
            }`}
          >
