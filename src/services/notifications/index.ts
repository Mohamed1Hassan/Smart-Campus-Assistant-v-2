...
export class NotificationServiceFactory {
  ...
  public getAttendanceNotificationsService(): AttendanceNotificationsService {
    if (!this.services.has("attendance")) {
      this.services.set(
        "attendance",
        new AttendanceNotificationsService(
          this.config.retry,
          this.config.rateLimit,
        ),
      );
    }
    return this.services.get("attendance") as AttendanceNotificationsService;
  }
  ...
  public getEmailNotificationsService(): EmailNotificationsService {
    ...
    return this.services.get("email") as EmailNotificationsService;
  }
  ...
  public getPushNotificationsService(): PushNotificationsService {
    ...
    return this.services.get("push") as PushNotificationsService;
  }
  ...
  public getNotificationTemplatesService(): NotificationTemplatesService {
    ...
    return this.services.get("templates") as NotificationTemplatesService;
  }
  ...
  public getNotificationManager(): NotificationManager {
    ...
    return this.services.get("manager") as NotificationManager;
  }
}
...
export class NotificationManager {
  ...
  public async sendNotification(
    ...
    try {
      ...
      const template = await this.templateService.getTemplate(
        `${type.toLowerCase()}-${user.language}`,
      );
  ...
  public async sendEmergencyNotification(
    ...
    for (const user of users) {
      try {
        const deliveries = await this.sendNotification(
          user,
        ...
        console.error(
          `Failed to send emergency notification to user ${user.id}:`,
          error,
        );
      }
    }
