              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-12">
                ...
                <div className="lg:w-[350px] shrink-0">
                  <GlassCard noBlur className="bg-white/10 border-white/20 p-8 shadow-2xl relative overflow-hidden group/timer">
                    ...
                    {nextExam.quiz?.submissions?.length > 0 ? (
                      <div className="w-full mt-10 p-5 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex flex-col items-center gap-2">
                        <div className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">Assessment Completed</div>
                        <div className="text-4xl font-black text-emerald-400">{nextExam.quiz.submissions[0].score} Points</div>
                      </div>
                    ) : (
                      <button
                        ...
                        <div className="flex-1 space-y-6 relative z-10">
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              {exam.quiz?.submissions?.length > 0 && (
                                <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-400 text-[9px] font-black uppercase rounded border border-emerald-500/30 flex items-center gap-1">
                                  <ShieldCheck className="w-3 h-3" /> {exam.quiz.submissions[0].score} Points
                                </span>
                              )}
                            </div>
